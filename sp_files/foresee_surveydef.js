var $$FSR = {
  ...
  'embedded': false,
  'replay_id': 'sportchek.ca',
  'site_id': 'sportchek.ca',
  'attach': false,
  'renderer': 'W3C',
  // or "ASRECORDED"
  'layout': 'CENTERFIXED',
 ...
 */
  FSR.surveydefs = [{
    ...
    alt: [{
      sp: 100,
      script: '//eval.bizrate.com/js/pos_227356.js'
    }],
    invite: {
      when: 'onentry'
    },
 ...
 */
  FSR.properties = {
    ...
    invite: {
      ...
      exclude: {
        urls: ['/shopping-cart.html', '/my-account/store-locator.html', '/flyer.html', '/checkout/shipping.html', '/checkout/billing.html', '/checkout/payment.html'],
        referrers: [],
        userAgents: [],
        browsers: [],
        cookies: [],
    ...
    cpps: {
      SPO2_2A: {
        source: 'function',
        value: function () {
          var elementid = document.getElementById("SPO2_2A");
          if (elementid !== null) {
            if (elementid.id == 'SPO2_2A') {
              return 'Y'
            }
          }
          return 'N';
      ...
      SPO2_2B: {
        source: 'function',
        value: function () {
          var elementid = document.getElementById("SPO2_2B");
          if (elementid !== null) {
            if (elementid.id == 'SPO2_2B') {
              return 'Y'
            }
          }
          return 'N';
      ...
      SPO2_2C: {
        ...
        value: function () {
          ...
          var elementid = document.getElementById("SPO2_2C");
          if (elementid !== null) {
            if (elementid.id == 'SPO2_2C') {
              return 'Y'
            }
          }
          return 'N';
      ...
      SPO2_2D: {
        source: 'function',
        value: function () {
          var elementid = document.getElementById("SPO2_2D");
          if (elementid !== null) {
            if (elementid.id == 'SPO2_2D') {
              return 'Y'
            }
          }
          return 'N';
      ...
      SPO2_2E: {
        source: 'function',
        value: function () {
          var elementid = document.getElementById("SPO2_2E");
          if (elementid !== null) {
            if (elementid.id == 'SPO2_2E') {
              return 'Y'
            }
          }
          return 'N';
      ...
      SPO2_2control: {
        source: 'function',
        value: function () {
          var elementid = document.getElementById("SPO2_2control");
          if (elementid !== null) {
            if (elementid.id == 'SPO2_2control') {
              return 'Y'
            }
          }
          return 'N';
